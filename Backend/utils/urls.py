...
from utils.api.views import ConstanceView, FlatPagesView, MultilingualViewSet
...
urlpatterns = [
    ...
    url(r'^language', MultilingualViewSet.as_view({'get':'getLanguage'}), name='multilingualview'),
